                  ...
                  <Card className="p-4">
                    <CardBody className="text-center">
                      ...
                      <InputGroup className="mb-3">
                        ...
                        <Input type="text" placeHolder={T.translate('login.labels.userName')} name="userName" onChange={this.handleChange} required min="4"/>
                      </InputGroup>
                      <InputGroup className="mb-4">
                        <InputGroupAddon addonType="prepend">
                          <i className="icon-lock" />
                        </InputGroupAddon>
                        <Input type="password" placeHolder={T.translate('login.labels.password')} name="password" onChange={this.handleChange} required min="4"/>
                      </InputGroup>
                      <Row>
                        {
