...
//                         </InputGroupAddon>
//                         <Input type="text" placeHolder={T.translate('login.labels.userName')} name="userName" onChange={this.handleChange} required minlength="4" />
//                       </InputGroup>
    ...
    return (
      <div className="App">
        ...
        <header className="App-header">
          <img src="https://shirbr510.github.io/react-toastify-demo/static/media/logo.5d5d9eef.svg" className="App-logo" alt="logo" />
