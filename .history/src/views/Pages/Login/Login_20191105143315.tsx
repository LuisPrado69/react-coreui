                    ...
                    <Card className="p-4">
                      <CardBody className="text-center">
                        ...
                        <InputGroup className="mb-3">
                          ...
                          <Input type="text" placeHolder={T.translate('labels.userName')} onChange={this.handleChange}/>
                        </InputGroup>
                        <InputGroup className="mb-4">
                          <InputGroupAddon addonType="prepend">
                            <i className="icon-lock" />
                          </InputGroupAddon>
                          <Input type="password" placeHolder={T.translate('labels.password')} onChange={this.handleChange}/>
                        </InputGroup>
                        <Row>
                          <Col xs="6">
