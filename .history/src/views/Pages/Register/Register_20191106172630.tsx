                              ...
                              <CardBody className="p-4">
                                 ...
                                 <InputGroup className="mb-3">
                                    ...
                                    <Input 
                                       type="text" 
                                       name="userName" 
                                       placeHolder={T.translate("register.labels.userName")} 
                                       required 
                                 ...
                                 <InputGroup className="mb-3">
                                    ...
                                    <Input 
                                       type="password" 
                                       name="password" 
                                       placeHolder={T.translate("register.labels.password")} 
                                       required 
                                       onChange={this.handleChange} 
                                       minlength="4" 
                                       className="form-control-warning" 
                                 ...
                                 <InputGroup className="mb-4">
                                    ...
                                    <Input 
                                       type="password" 
                                       name="repeatPassword" 
                                       placeHolder={T.translate("register.labels.repeatPassword")} 
                                       required 
                                       onChange={this.handleChange} 
                                       minlength="4" 
                                       className="form-control-warning" 
